...
"""
Add default config for MixFormer with custom dataset.
"""
cfg = edict()
...
cfg.MODEL.BACKBONE.MIX_BLOCK = "MixBlock"
cfg.MODEL.BACKBONE.CE_LOC = [3, 6, 9]
cfg.MODEL.BACKBONE.CE_KEEP_RATIO = [1, 1, 1]
cfg.MODEL.BACKBONE.CE_START_EPOCH = 0  # candidate elimination start epoch
cfg.MODEL.BACKBONE.CE_WARM_EPOCH = 0  # candidate elimination warm up epoch
cfg.MODEL.BACKBONE.CE_COUNT_EPOCH = 999
cfg.MODEL.BACKBONE.PRETRAINED_PATH = './pretrained_models/mae_pretrain_vit_base.pth'
