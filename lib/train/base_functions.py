...
# datasets related
from lib.train.dataset import Lasot, Got10k, MSCOCOSeq, ImagenetVID, TrackingNet, Custom
...
def names2datasets(name_list: list, settings, image_loader):
    ...
    for name in name_list:
        assert name in ["LASOT", "GOT10K_vottrain", "GOT10K_votval", 
                        "GOT10K_train_full", "COCO17", "VID", "TRACKINGNET", "CUSTOM"]
        if name == "LASOT":
        ...
        if name == "CUSTOM":
            ...
            datasets.append(Custom(settings.env.custom_dir, image_loader=image_loader))
    return datasets
